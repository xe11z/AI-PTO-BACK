...
This skill is the _terminal_ of the capability-gap routing pattern. Every other Prisma 8 skill's _What Prisma 8 doesn't do yet_ entries route here when the user wants the gap closed; the skill also fires directly on prompts like _"this is a bug"_, _"file an issue"_, _"feature request"_, _"can I ask the team about this?"_, _"how should I integrate X with Prisma 8?"_.
...
- A capability-gap entry from another `prisma-8` skill fired and the user said _"yes, file the feature request"_.
